...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\PythonProjects_Tehnikum\Tipizaciya_Logirovanie\bot48'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\PythonProjects_Tehnikum\Tipizaciya_Logirovanie\bot48\Scripts\deactivate.nu'
